...
exports.nestedToFlat = void 0;
//  递归方法
var nestedToFlat = function (arr, pId, pKey, childKey) {
    if (pId === void 0) { pId = 0; }
    ...
    return [].concat.apply([], arr.map(function (item) {
        ...
        return [].concat.apply([], __spreadArray([__assign(__assign({}, item), { pId: pId })], (0, exports.nestedToFlat)(temp, item[pKey], pKey, childKey), false));
    }));
};
